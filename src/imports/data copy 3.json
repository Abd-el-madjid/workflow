export const BEFORE_SECS = [
  {
    ...
    items: [
      ...
      // Diplômes
      {
        id: "r-dip1",
        t: "Diplôme original",
        d: "1 original + 3 copies certifiées",
        s: "",
        g: ["req"],
        linkedTo: "dip1",
      },
      ...
      },
      {
        ...
        d: "1 original certifiée par année",
        s: "",
        g: ["req"],
        linkedTo: "dip3",
      },
      // Identité & Civil
      {
        ...
        d: "1 original + 2 jeux complets de photocopies",
        s: "",
        g: ["req"],
        linkedTo: "civ1",
      },
      {
        id: "r-civ2",
        t: "Photos d'identité OACI",
        d: "2 photos (35×45 mm, fond blanc)",
        s: "",
        g: ["req"],
        linkedTo: "civ2",
      },
      {
        ...
        d: "1 original + 2 copies certifiées (+ traduction si arabe)",
        s: "",
        g: ["req"],
        linkedTo: "civ3",
      },
      ...
      {
        id: "r-gf2",
        t: "Bulletins de salaire belle-sœur (3 mois)",
        d: "1 jeu + 1 copie par mois",
        s: "",
        g: ["req"],
        linkedTo: "gf2",
      },
      {
        id: "r-gf3",
        t: "Relevés bancaires belle-sœur (3 mois)",
        d: "1 jeu + 1 copie par mois",
        s: "",
        g: ["req"],
        linkedTo: "gf3",
      ...
      {
        id: "r-gf4",
        t: "Pièce d'identité belle-sœur",
        d: "Recto-verso (1 copie)",
        s: "",
        g: ["req"],
        linkedTo: "gf4",
      },
      ...
      {
        id: "r-gd1",
        t: "Attestation prise en charge parent (légalisée)",
        d: "1 original légalisé + 1 copie",
        s: "",
        g: ["opt"],
        linkedTo: "gd1",
      ...
      {
        id: "r-gd2",
        t: "Attestation pension retraite parent",
        d: "1 original + 1 copie",
        s: "",
        g: ["opt"],
        linkedTo: "gd2",
      ...
      {
        id: "r-lgt1",
        t: "Confirmation réservation hôtel Besançon",
        d: "1 copie",
        s: "",
        g: ["req"],
        linkedTo: "lgt1",
