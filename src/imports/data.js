  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        print: "📄 ORIGINAL physique + copies certifiées N&B — Document papier. Tu présentes l'original, CAPAGO garde une copie certifiée. Pas d'impression couleur nécessaire.",
        g: ["don"],
      },
      {
        id: "dip3",
        ...
        print: "📄 ORIGINAL papier + photocopie N&B — Documents délivrés par l'université. Tu présentes les originaux, CAPAGO garde les photocopies. Pas d'impression couleur.",
        g: ["req"],
      },
      {
        id: "dip4",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        print: "📄 ORIGINAL papier + photocopie N&B — Bulletins papier émis par l'employeur. Pas d'impression couleur.",
        g: ["req"],
      },
      {
        id: "fin3",
        ...
        print: "📄 ORIGINAL papier (bureau de poste) ou 🖨️ COULEUR ×1 + N&B ×1 si PDF BaridiWeb — Si tu l'imprimes depuis BaridiWeb : 1 couleur + 1 N&B. Si papier reçu à la poste : original + photocopie N&B.",
        g: ["req"],
      },
      {
        id: "fin4",
        ...
        print: "🖨️ N&B ×1 — Document que tu crées toi-même. Une seule impression N&B suffit. Pas besoin de couleur.",
        g: ["req"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        print: "🖨️ COULEUR ×1 + N&B ×1 — PDF numérique reçu par email. CAPAGO garde le N&B, tu gardes le couleur.",
        g: ["req"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        print: "📄 ORIGINAL papier légalisé (mairie Paris) + photocopie N&B — Elle t'envoie l'original physique par DHL. CAPAGO garde la photocopie N&B, tu gardes l'original.",
        g: ["req"],
      },
      {
        id: "gf2",
      ...
      },
      {
        ...
        print: "🖨️ COULEUR ×1 + N&B ×1 — Scan/photo reçu par WhatsApp. CAPAGO garde le N&B, tu gardes le couleur.",
        g: ["req"],
      },
      {
        id: "gf5",
        ...
        print: "🖨️ COULEUR ×1 + N&B ×1 — PDF reçu par email/WhatsApp. CAPAGO garde le N&B, tu gardes le couleur.",
        g: ["req"],
      },
      {
        id: "gf6",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        print: "📄 ORIGINAL papier (bureau de poste) ou 🖨️ COULEUR ×1 + N&B ×1 si PDF BaridiWeb — Même règle que tes propres relevés CCP.",
        g: ["opt"],
      },
      {
        id: "gd4",
        ...
        print: "📄 ORIGINAL + photocopie N&B — Document physique. Pas d'impression couleur.",
        g: ["opt"],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        print: "🖨️ N&B ×1 — Fait partie de ta lettre explicative. Une seule impression N&B.",
        g: ["req"],
      },
    ],
  },
